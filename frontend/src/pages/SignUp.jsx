      ...
      <div className="flex overflow-hidden items-center w-screen justify-center flex-col h-screen bg-[#F0F0F0]">
        <div className="flex w-full items-center">
          <div className="left w-[30%] flex flex-col ml-[100px]">
            <div className='w-[210px] text-4xl font-extrabold'>DocNest</div>
            <form onSubmit={createUser} className='pl-3 mt-5' action="">
              <div className='inputCon'>
                <p className=' text-[14px] text-[#808080] font-semibold'>Username</p>
              ...
              <div className='inputCon'>
                <p className=' text-[14px] text-[#808080] font-semibold'>Name</p>
                <div className="inputBox w-[100%]">
              ...
              <div className='inputCon'>
                <p className=' text-[14px] text-[#808080] font-semibold'>Email</p>
                <div className="inputBox w-[100%]">
                  <i><MdEmail /></i>
              ...
              <div className='inputCon'>
                <p className=' text-[14px] text-[#808080] font-semibold'>Phone</p>
                <div className="inputBox w-[100%]">
                  <i><FaPhone /></i>
              ...
              <div className='inputCon'>
                <p className=' text-[14px] text-[#808080] font-semibold'>Password</p>
                <div className="inputBox w-[100%]">
